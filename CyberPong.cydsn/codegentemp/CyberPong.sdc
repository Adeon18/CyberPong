...
# Date: Tue, 14 Dec 2021 10:03:57 GMT
#set_units -time ns
create_clock -name {ClockTimer(FFB)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/ff_div_7}]]
...
create_clock -name {FanController_PWM_CLOCK_25k_10b_1(FFB)} -period 41.666666666666664 -waveform {0 20.8333333333333} [list [get_pins {ClockBlock/ff_div_8}]]
...
create_generated_clock -name {ClockTimer} -source [get_pins {ClockBlock/hfclk}] -edges {1 48001 96001} [list]
...
# Project: C:\Users\Ade0n\Desktop\PR\CyberPong\CyberPong.cydsn\CyberPong.cyprj
# Date: Tue, 14 Dec 2021 10:03:52 GMT
