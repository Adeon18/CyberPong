...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F3074u, /* Base address: 0x400F3000 Count: 116 */
			0x400F313Eu, /* Base address: 0x400F3100 Count: 62 */
			0x400F3264u, /* Base address: 0x400F3200 Count: 100 */
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x15480000u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x000000EEu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00CB1DB6u);
