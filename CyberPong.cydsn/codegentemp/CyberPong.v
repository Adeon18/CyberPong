...
module FanController_v4_10_3 (
    ...
    defparam B_FanCtrl.NumOfFans = 1;
	...
	assign pwm[2] = Net_438;

    assign Net_438 = 1'h0;

	// VirtualMux_24 (cy_virtualmux_v1_0)
	assign pwm[4] = Net_441;
...
module top ;
    ...
    TCPWM_P4_v2_10_1 Perioud_Counter (
        .capture(Net_676),
        .cc(Net_658),
        .clock(Net_598),
        .count(Net_584),
    ...
    FanController_v4_10_3 FanController (
        .alert(Net_617),
        .bank(Net_646[8:1]),
        .bank1(Net_618),
        .bank2(Net_619),
