...
void FanController_PID_ISR_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)FanController_PID_ISR__INTC_NUMBER] = address;
}
...
cyisraddress FanController_PID_ISR_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)FanController_PID_ISR__INTC_NUMBER];
}
...
{
    *FanController_PID_ISR_INTC_PRIOR = priority << 5;
}
...
uint8 FanController_PID_ISR_GetPriority(void)
{
    ...
    priority = *FanController_PID_ISR_INTC_PRIOR >> 5;
