...
#define Pin_Input_RIGHT_0_PS		(Pin_Input_RIGHT__0__PS)
#define Pin_Input_RIGHT_0_PC		(Pin_Input_RIGHT__0__PC)
#define Pin_Input_RIGHT_0_DR		(Pin_Input_RIGHT__0__DR)
#define Pin_Input_RIGHT_0_SHIFT	(Pin_Input_RIGHT__0__SHIFT)
#define Pin_Input_RIGHT_0_INTR	((uint16)((uint16)0x0003u << (Pin_Input_RIGHT__0__SHIFT*2u)))
